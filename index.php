            ...
            <div class="form">
                <div class="half">
                    <div class="area">
                        ...
                        <input class="input_half1" type="phone" name="lastname">
                    </div>
                    <div class="area">
                        <label class="name">Имя</label>
                        <input class="input_half1" type="phone" name="name">
                    </div>
                    <div class="area">
                ...
                <div class="half">
                    <div class="area">
                        ...
                        <div class="area">
                            ...
                            <input class="input_half1" type="phone" name="other">
                        </div>
                    </div>
                </div>
            </div>
...
$address="kamilaibr2002@mail.ru";
// текст письма 
$note_text="Тема : $urok \r\nИмя : $name \r\n Email : $email \r\n Дополнительная информация : $phone";

if (isset($name)) {
mail($address,$urok,"Content-type:phone/plain; windows-1251"); 
